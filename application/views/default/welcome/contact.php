		...
		<div class="container">
			<div class="content">
				...
				<div class="news_container">
					...
					<div class="map">
					<script type="text/javascript" charset="utf-8" src="https://api-maps.yandex.ru/services/constructor/1.0/js/?sid=ZwEL0Q_YI2_SZsuoUoVstOS8RsDttarR&width=100%&height=400&lang=ru_RU&sourceType=constructor"></script>
					</div>
				</div>
