...
class News extends Admin_Controller {
   ...
   public function action_comm_delete($id){
       $this->db->delete('comments',array(
           'to_comm'=>$id
       ));
       $this->session->set_flashdata('status',"<center><p style='background-color:#B2FF00'>Комментарий успешно удален</p></center>");
       redirect('admin/components/news/news_edit/'.$id);
